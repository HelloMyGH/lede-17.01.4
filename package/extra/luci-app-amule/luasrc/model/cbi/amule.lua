...
o.description = "<strong><font color=\"red\">"..translate("Please create the temporary directory before enabling aMule.").."</font></strong>"

o = s:taboption("path_and_file", Value, "incoming_dir", translate("Incoming directory"))
o.rmempty = false
o.placeholder = "/var/run/amule/.aMule/Incoming"
o.description = "<strong><font color=\"red\">"..translate("Please create the incoming directory before enabling aMule.").."</font></strong>"
